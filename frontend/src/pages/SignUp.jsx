...
export default function SignUp() {
  ...
  return (
    <div style={{
      ...
      <div className="spotlight-glow" style={{ bottom: '15%', left: '10%', width: '500px', height: '500px', background: 'radial-gradient(circle, rgba(242, 184, 75, 0.03) 0%, transparent 70%)', opacity: 0.6 }} />
